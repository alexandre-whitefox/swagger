...
{ 
    ...
    { 
        ...
        [HttpPost]
        [Route("/Actions/ChangeScheduler")]
        [ValidateModelState]
        [SwaggerOperation("ActionsChangeSchedulerPost")]
        [SwaggerResponse(statusCode: 200, type: typeof(Context), description: "Success")]
        public virtual IActionResult ActionsChangeSchedulerPost([FromBody]ScheduleParameters body)
        { 
