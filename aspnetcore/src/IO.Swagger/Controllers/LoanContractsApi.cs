...
{ 
    ...
    /// </summary>
    [ApiController]
    public class LoanContractsApiController : ControllerBase
    { 
        /// <summary>
        /// 
        /// </summary>
        ...
        [HttpGet]
        [Route("/LoanContracts/List")]
        [ValidateModelState]
        [SwaggerOperation("LoanContractsListGet")]
        [SwaggerResponse(statusCode: 200, type: typeof(Context), description: "Success")]
        public virtual IActionResult LoanContractsListGet([FromQuery]string f)
        { 
