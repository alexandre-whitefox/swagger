...
{ 
    ...
    { 
        ...
        /// <response code="200">Ok</response>
        [HttpPost]
        [Route("/PortfolioReport/SaveWeight")]
        [ValidateModelState]
        [SwaggerOperation("PortfolioReportSaveWeightPost")]
        public virtual IActionResult PortfolioReportSaveWeightPost([FromBody]TargetWeight body)
        { 
            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200);
